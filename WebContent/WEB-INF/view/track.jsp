...
<c:otherwise>
 ...
 <div id="qty" >
		<form   action="/Defynu/cancel?orderid=${orderid[status.index]}" method="POST">
 
			 <button class="btn btn-primary btn-sm" id="cancel" type="submit" formmethod="POST" formaction="/Defynu/cancel?orderid=${orderid[status.index]}">Cancel</button>
</form>
	</div>
	</c:if>
