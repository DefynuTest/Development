...
<form action="/Defynu/confrim" method = "GET">	
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <h5>Standard Size:</h5>
		...
		<button type="submit" class="btn btn-primary btn-xs" formaction="/CottonCaress/measurement" name= "object" value= 1>Add Your Body Measuremensts</button>&nbsp;
...
<h4>${value.profile}</h4>
	...
	<form align="right" action="/Defynu/confrim" method="GET" target="_self">

  <input type="submit"   style="float:right" class="btn btn-success btn-lg btn-margin-right" value="Confrim Order" align="right">
</form>
