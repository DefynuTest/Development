...
<form action="/Defynu/measurement" method = "GET">	
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <h5>Standard Size:</h5>
		...
		<button type="submit" class="btn btn-primary btn-xs" formaction="/Defynu/measurement" name= "object" value= 0>Add Your Body Measuremensts</button>&nbsp;
...
<button id="atc" onclick="loadDoc('/Defynu/designa?body=1&outercollar=bc1&innercollar=1&outercuff=1&innercuff=1&button=1&buttonplacket=1&outsidefastening=1&price=800&pocket=1')">Reset</button> 
		</div>
