            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="hero-content text-center">
                        <a href="/Defynu/design?body=1&outercollar=1&innercollar=1&outercuff=1&innercuff=1&button=1&buttonplacket=1&outsidefastening=1&price=800" class="btn btn-fill btn-large btn-margin-right">CUSTOMIZE MY SHIRT</a> 
                    </div>
                </div>
            </div>
        </div>
