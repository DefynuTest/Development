 ...
 -->
	...
	<section class="blog text-center">
		...
		<div class="content-wrapper">
            ...
            <div class="row"> 
        <c:forEach items="${shirtlist}" var="value" varStatus="status">       
		 <div class="col-md-4">
		  ...
		  <div  id="bg"><img src="resources/body/bg.png"></div>
		 <div id="body"><img src="resources/body/bodys${value.getBody()}.png"></div>
		    <div id="innercollar"><img src="resources/innercollar/innercollars${value.getInnercollar()}.png"></div>
 			<div id="outercollar"><img src="resources/outercollar/outercollarsbc000${value.getOutercollar()}.png"></div>
			<div id="outsidefastening"><img src="resources/outsidefastening/outsidefastenings${value.getOutsidefastening()}.png"></div>
			<div id="button"><img src="resources/button/buttons${value.getButton()}.png"></div>
			<div id="innercuff"><img src="resources/innercuff/innercuffs${value.getInnercollar()}.png"></div>
 			<%-- <div id="outercuff"><img src="resources/outercuff/outercuffssb${value.getOuttercuff()}.png"></div>
 			 --%>
...
<!--                             <p>100% Cotton,${value.getWeave()}	</p> -->
                           ...
                           <span class="price"><i class="fa fa-inr"></i></span>&nbsp;${value.getPrice()}<span style="color:#009900">(30% Discount on Checkout)</span>
                            </figcaption> --%>
