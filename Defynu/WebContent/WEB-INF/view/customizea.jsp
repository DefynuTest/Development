...
<button id="atc" onclick="loadDoc('/designa?body=1&outercollar=1&innercollar=1&outercuff=1&innercuff=1&button=1&buttonplacket=1&outsidefastening=1&price=800&pocket=1')">Reset</button> 
