...
<form  action="/change?body=${shirt}&outercollar=${OuterCollar}&innercollar=${InnerCollar}&outercuff=${OuterCuff}&innercuff=${InnerCuff}&button=${Button}&buttonplacket=${ButtonPlacket}&outsidefastening=${OutsideFastening}&price=${Price}&pocket=${Pocket}&orderid=${order_id}" method="post" target="_self">

  <input type="submit" style="background-color:#000"  class="btn btn-success" value="CHANGE"> 
</form>	
		</div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="contact">
                <h5 style="color:#fff;text-transform:none;">Contact Us<br>Email:&nbsp;support@bespokart.in<br>Phone:&nbsp;+91-9563862124,&nbsp; +91-8902289337</h5>
            </div>
            </div> 
            </div>
