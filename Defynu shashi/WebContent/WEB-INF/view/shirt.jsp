 ...
 -->
	...
	<section class="blog text-center">
        ...
        <c:forEach items="${fabric}" var="value" varStatus="status">       
		 ...
		 <div id="body"><img src="resources/body/bodys${value.getSl()}.png"></div>
		    <div id="innercollar"><img src="resources/innercollar/innercollars000${value.getSl()}.png"></div>
 			<div id="outercollar"><img src="resources/outercollar/outercollarsbc000${value.getSl()}.png"></div>
			<div id="outsidefastening"><img src="resources/outsidefastening/outsidefastenings${value.getSl()}.png"></div>
			<div id="button"><img src="resources/button/buttons${value.getSl()}.png"></div>
			<div id="innercuff"><img src="resources/innercuff/innercuffs${value.getSl()}.png"></div>
 			<div id="outercuff"><img src="resources/outercuff/outercuffssb000${value.getSl()}.png"></div>
